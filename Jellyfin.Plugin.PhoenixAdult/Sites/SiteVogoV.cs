...
{
    public class SiteVogoV : IProviderBase
    {
        ...
        foreach (var sceneURL in googleResults)
        {
            ...
            if (http.IsOK)
            {
                ...
                var titleNode = doc.DocumentNode.SelectSingleNode(@"//div[@class=""video-page-header""]//h1");
        ...
        movie.Name = doc.DocumentNode.SelectSingleNode(@"//div[@class=""video-page-header""]//h1")?.InnerText.Trim();
        movie.Overview = doc.DocumentNode.SelectSingleNode(@"//div[@class=""info-video-description""]//p")?.InnerText.Trim();
        movie.AddStudio("Unknown");

        var dateNode = doc.DocumentNode.SelectSingleNode(@"//ul[@class=""list-unstyled info-video-details""]//li[1]//span");
