...
namespace PhoenixAdult.Sites
{
    public class SiteMormonGirlz : IProviderBase
    {
        ...
        public async Task<MetadataResult<BaseItem>> Update(int[] siteNum, string[] sceneID, CancellationToken cancellationToken)
        {
            ...
            movie.Name = doc.DocumentNode.SelectSingleNode("//meta[@property='og:title']").GetAttributeValue("content", string.Empty).Replace(" - Mormon Girlz", "").Trim();
            ...
            {
                var genreName = genreLink.InnerText.Replace("more of", "").Trim();
