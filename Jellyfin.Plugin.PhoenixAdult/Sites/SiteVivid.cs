    ...
    public class SiteVivid : IProviderBase
    {
        ...
        foreach (var sceneURL in googleResults)
        {
            ...
            if (http.IsOK)
            {
                ...
                var titleNode = doc.DocumentNode.SelectSingleNode(@"//h2[@class=""scene-h2-heading""]");
        ...
        movie.Overview = doc.DocumentNode.SelectSingleNode(@"//p[@class=""indie-model-p""]")?.InnerText.Trim();
