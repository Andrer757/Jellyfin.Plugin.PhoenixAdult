...
{
    public class SiteVirtualTaboo : IProviderBase
    {
        ...
        foreach (var sceneURL in googleResults)
        {
            ...
            if (http.IsOK)
            {
                ...
                var titleNode = doc.DocumentNode.SelectSingleNode(@"//div[contains(@class, ""right-info"")]//h1");
        ...
        movie.Name = doc.DocumentNode.SelectSingleNode(@"//div[contains(@class, ""right-info"")]//h1")?.InnerText.Trim();
        movie.Overview = doc.DocumentNode.SelectSingleNode(@"//p[@class=""description""]")?.InnerText.Trim();
