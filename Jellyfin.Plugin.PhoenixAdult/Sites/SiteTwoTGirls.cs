...
{
    public class SiteTwoTGirls : IProviderBase
    {
        ...
        movie.Overview = doc.DocumentNode.SelectSingleNode(@"//div[@class=""shadow video-details""]/p")?.InnerText.Trim();
        movie.AddStudio("TwoTGirls");
