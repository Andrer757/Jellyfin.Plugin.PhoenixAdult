...
{
    public class SiteXevUnleashed : IProviderBase
    {
        ...
        movie.AddStudio("Xev Unleashed");

        var dateNode = doc.DocumentNode.SelectSingleNode(@"//span[@class=""availdate""]/br/preceding-sibling::text()");
