...
namespace PhoenixAdult.Sites
{
    public class SiteWeAreHairy : IProviderBase
    {
        ...
        movie.Overview = doc.DocumentNode.SelectSingleNode(@"//div[@class=""desc""]/div[1]/p")?.InnerText.Trim();
        movie.AddStudio("We Are Hairy");

        var dateNode = doc.DocumentNode.SelectSingleNode(@"//span[@class=""added""]/time");
